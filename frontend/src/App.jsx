        ...
        <div className="min-h-screen bg-gray-100 p-8 dark:bg-gray-900">
            <div className="mx-auto max-w-4xl space-y-8">
                ...
                <div className="text-center">
                    ...
                    <p className="mt-2 text-gray-600 dark:text-gray-400">Simple Appointment Booking</p>
                </div>
                        ...
                        <div className="grid gap-4 md:grid-cols-2">
                            {appointments.map((apt) => (
                                <div key={apt.id} className="bg-white p-5 rounded-lg shadow hover:shadow-md transition-shadow dark:bg-gray-800 border-l-4 border-emerald-500">
                                    ...
                                    <div className="mt-3">
                                        <span className={`inline-block px-2 py-1 text-xs rounded-full ${apt.status === 'scheduled' ? 'bg-green-100 text-green-800' :
